...
protected:
	...
	virtual smtutil::Expression twosComplementToSigned(smtutil::Expression _value);
	virtual smtutil::Expression signedToTwosComplement(smtutil::Expression _value);
